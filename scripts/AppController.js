export function AppController() {
  ...
  this.init = function (mybox, mymodel) {
    ...
    document.addEventListener("DOMContentLoaded", () => {
      ...
      document.addEventListener("click", (e) => {
        ...
        switch (true) {
          ...
          case e.target.id === "lib-submit-btn":
            {
              ...
              if (
                ...
                form.expcode1.length == 2 &&
                form.expcode2.length == 2 &&
                form.cvc.length == 3
              ) {
                this.byyLibCard();
                this.closeLibModal();
          ...
          case e.target.id === "register" || e.target.id === "digital-singUp":
            ...
            break;
          case e.target.id === "go-to-register-btn":
            ...
            break;
          case e.target.id === "go-to-login-btn":
      ...
      /*     let cardCheck = {};
      let libcard = new FormData(document.getElementById("lib-form"));
      console.log(libcard);
      for (let [key, value] of libcard) {
        cardCheck[key] = libcard[value];
      }
      console.log(cardCheck);
      document.addEventListener("change", (e) => {
        switch (true) {
          case e.target.id === "cardnumber":
            {
              if (
                cardCheck.cardnumber.length == 16 &&
                cardCheck.expcode1.length == 2 &&
                cardCheck.expcode2.length == 2 &&
                cardCheck.cvc.length == 3
              ) {
                this.byyLibCard();
              }
            }
            break;
          case e.target.id === "expcode1":
            {
              if (
                cardCheck.cardnumber.length == 16 &&
                cardCheck.expcode1.length == 2 &&
