...
export function AppView() {
  ...
  this.closeLibModal = function () {
    document.getElementById("lib-modal").classList.remove("visible");
    document.getElementById("lib-modal").classList.remove("animation-open");
  ...
  this.noDisabledNextArrow = function () {};
