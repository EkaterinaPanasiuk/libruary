export class Carusel {
  ...
  coloringDot(num) {
    this.dotCollection = document.querySelectorAll(`.dot`);
    this.dotCollection.forEach((i) => i.classList.remove("active-dot"));
    this.dotCollection[num].classList.add("active-dot");
  }
  renderDots() {
    let dotNumber;
    ...
    console.log(this.differNumber + "  differNumber");
  ...
  unDisabledBtn(btn) {
    const parent = btn.closest(".about-btn");
    parent.removeAttribute("disabled", "");
    btn.classList.remove("about-btn");
  }
  disabledBtn(btn) {
    const parent = btn.closest(".about-btn");
