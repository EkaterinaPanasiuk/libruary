...
export function AppModel() {
  ...
  this.updateUser = function () {
    ...
    this.updeteCardNumber(user);
    this.updateProfileText(user);
    this.chengeCardCheck(user);
    console.log(user);
  ...
  this.sendRegisterData = function (registerForm) {
    ...
    userRegisterData.libruaryCard = false;
  ...
  this.sentRegistrationDatatoLocalstorage = function () {
    ...
    // this.sentRegistrationDatatoLocalstorageNextstep();
  };
  /*  this.sentRegistrationDatatoLocalstorageNextstep = function () {
    console.log(usersData);
  ...
  this.addBookForDB = function (id, name, author) {
    ...
    view.renderDataToMyProfileModal(user, "profile-modal");
  };
  this.byyLibCard = function () {
    user.libruaryCard = true;
  };
